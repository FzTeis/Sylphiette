...
ress.on('ready', async () => {
await m.reply("Procesando *instalación* del panel del servidor \nEspere entre 1 y 10 minutos hasta que se complete el proceso")
