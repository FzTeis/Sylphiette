...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} Ganaste 🏆 ¡Te llevas 4999 coins 🪙!` : isTie ? 'El juego terminó en empate.' : `* Turno de @${room.game.currentTurn.split('@')[0]}`}
`.trim();
